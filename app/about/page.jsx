  ...
  return (
    <div>
             ...
             <div className='flex flex-col gap-y-4'>
                   <h2 className="text-white text-3xl font-bold text-start">About us</h2>
                  <h2 className="text-white text-sm font-bold text-start flex items-center gap-1">Home <BiSolidRightArrow className="w-3 h-3 text-white" /> About</h2>
             </div>
                </div>
              </div>
        <Aboutvid/>
